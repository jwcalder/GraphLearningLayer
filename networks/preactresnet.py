...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 16 16:48:07 2020
...
class PreActResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10,widen=None):
        super(PreActResNet, self).__init__()        
        self.layers = np.asarray([64,128,256,512])           
        self.in_planes = self.layers[0]
        self.conv1 = nn.Conv2d(3, self.layers[0], kernel_size=3, stride=1, padding=1, bias=False)
